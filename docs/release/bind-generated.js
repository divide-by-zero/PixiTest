...
Object.defineProperties(game.ScrollingBackground.prototype, {
  ...
  distance: {
    ...
    set: function(v) { this._distance = (v|0); },
  },
});
game.ScrollingBackground._size = 6;
game.ScrollingBackground._fromPtr = function(ptr, v) {
  v = v || Object.create(game.ScrollingBackground.prototype);
  v._speed = HEAP16[(ptr+0)>>1];
  v._threshold = HEAP16[(ptr+2)>>1];
  v._distance = HEAP16[(ptr+4)>>1];
  return v;
};
game.ScrollingBackground._toPtr = function(ptr, v) {
  HEAP16[(ptr+0)>>1] = v.speed;
  HEAP16[(ptr+2)>>1] = v.threshold;
  HEAP16[(ptr+4)>>1] = v.distance;
};
...
game.ScrollingBackground._tempHeapPtr = function(v) {
  var ptr = ut.tempHeapPtrBufferZero(6);
...
Object.defineProperties(game.ScrollingBackground, { cid: { configurable: true, get: function() { delete game.ScrollingBackground.cid; var offsetsPtr = 0, offsetsCount = 0; return game.ScrollingBackground.cid = Module._ut_component_register_cid(/*game.ScrollingBackground*/ 6, 2, 0, offsetsPtr, offsetsCount, 0/*"game::ScrollingBackground"*/, 0, 0); } } });
...
game.ScrollingBackground.speed = { $ofs:0, $t:"int16_t", $c:game.ScrollingBackground };
game.ScrollingBackground.threshold = { $ofs:2, $t:"int16_t", $c:game.ScrollingBackground };
game.ScrollingBackground.distance = { $ofs:4, $t:"int16_t", $c:game.ScrollingBackground };
